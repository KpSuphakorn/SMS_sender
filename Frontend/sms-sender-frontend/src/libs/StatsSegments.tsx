...
const data = [
  { label: 'TRUE', count: '204,001', part: 59, color: '#47d6ab' },
  { label: 'AIS', count: '121,017', part: 35, color: '#03141a' },
  { label: 'DTAC', count: '31,118', part: 6, color: '#4fcdf7' },
  { label: 'NT', count: '10,000', part: 3, color: '#4dcdc4'}
];
