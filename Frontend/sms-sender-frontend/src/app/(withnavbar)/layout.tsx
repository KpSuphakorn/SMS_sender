              ...
              {session?.user ? (
                <>
                  ...
                  <div className="flex items-center space-x-1 mr-6">
                    ...
                    {(userRole === 'telco' || userRole === 'ais' || userRole === 'dtac' || userRole === 'true' || userRole === 'nt') && (
                      <Link href="/telco" className="px-4 py-2 text-sm font-medium text-gray-700 hover:text-blue-600 hover:bg-blue-50/50 rounded-lg transition-all duration-200">
                        จัดการข้อมูล Telco
                      </Link>
                    )}
                    ...
                    <div className="space-y-2">
                      {userRole === 'admin' && (
                        <>
                          ...
                          <Link href="/support-letter" className="flex items-center px-4 py-3 rounded-lg text-gray-700 hover:text-blue-600 hover:bg-blue-50/50 font-medium transition-all duration-200">
                            <svg className="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      ...
                      {(userRole === 'telco' || userRole === 'ais' || userRole === 'dtac' || userRole === 'true' || userRole === 'nt') && (
                        <Link href="/telco" className="flex items-center px-4 py-3 rounded-lg text-gray-700 hover:text-blue-600 hover:bg-blue-50/50 font-medium transition-all duration-200">
                          <svg className="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      ...
                      {(userRole === 'admin' || userRole === 'user') && (
                        <Link href="/all-data" className="flex items-center px-4 py-3 rounded-lg text-gray-700 hover:text-blue-600 hover:bg-blue-50/50 font-medium transition-all duration-200">
                          <svg className="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                          </svg>
                          ค้นหาข้อมูลทั้งหมด
